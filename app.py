...
if page=="Dashboard OEE":
    ...
    # Le fasce sintetiche mantengono la lettura equivalente standardizzata;
    # la tabella sottostante distingue fisico ed equivalente.
    summary_band("Comber – Aqueous extraction","navy",df,"Comber","equivalente",periods)
    summary_band("Spray Dryer – Drying","green",df,"Spray Dryer","equivalente",periods)
